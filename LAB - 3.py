...
def main():
    ...
    try:
        initial_board = [int(num) for num in input_board]
        if set(initial_board) != set(range(9)):
            print("Invalid board. Please enter numbers from 0 to 8.")
            return
    except ValueError:
